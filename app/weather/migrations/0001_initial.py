# Generated by Django 4.0.2 on 2022-12-02 07:39
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('max_t', models.DecimalField(decimal_places=2, max_digits=10, null=True)),
                ('min_t', models.DecimalField(decimal_places=2, max_digits=10, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            name='weather_forecast_cambodia',
            fields=[
                ('id', models.IntegerField(primary_key=True, serialize=False)),
                ('date_data', models.DateField()),
