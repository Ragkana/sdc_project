...
# Opening JSON file
rf = json.load(open('/home/sdc/www/django_apps/weather_data/rf_cambodia.json'))
rh = json.load(open('/home/sdc/www/django_apps/weather_data/rh_cambodia.json'))
tmax = json.load(open('/home/sdc/www/django_apps/weather_data/tmax_cambodia.json'))
tmin = json.load(open('/home/sdc/www/django_apps/weather_data/tmin_cambodia.json'))
ws = json.load(open('/home/sdc/www/django_apps/weather_data/ws_cambodia.json'))
...
sql_query = pd.read_sql_query (''' SELECT * FROM weather_forecast_cambodia ''', conn)
...
for index, row in wf2.iterrows():
  cur.execute(''' UPDATE weather_forecast_cambodia SET rainfall = ?, humidity = ?, max_temp = ?, 
...
filtered_wf.to_sql(name='weather_forecast_cambodia', con=conn, if_exists='append', index=False)
conn.commit()

cur.execute("SELECT * FROM weather_forecast_cambodia ORDER BY id DESC LIMIT 15")
...
for row in cur.fetchall():
    print (row)
>>>>>>> 99219b74c0aeb255c4675d182187f33846c83035
