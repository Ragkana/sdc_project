...
# Opening JSON file
rf = json.load(open('D:/Django/SDC/Backend_Code/wf_data/rf_15072022_laos.json'))
rh = json.load(open('D:/Django/SDC/Backend_Code/wf_data/rh_15072022_laos.json'))
tmax = json.load(open('D:/Django/SDC/Backend_Code/wf_data/tmax_15072022_laos.json'))
tmin = json.load(open('D:/Django/SDC/Backend_Code/wf_data/tmin_15072022_laos.json'))
ws = json.load(open('D:/Django/SDC/Backend_Code/wf_data/ws_15072022_laos.json'))
